<template>
  <div>
    ...
    <header class="flex items-center justify-between p-4">
      ...
      <div
        v-if="menuOpen"
        class="absolute top-16 right-4 w-40 bg-white shadow-lg rounded-lg p-2 sm:hidden"
      >
...
const links = ref([
  { name: 'YouTube', icon: new URL('/src/assets/img/shortcuts/youtube.png', import.meta.url).href },
  { name: 'Yahoo', icon: new URL('/src/assets/img/shortcuts/yahoo.png', import.meta.url).href },
  { name: 'ChatGPT', icon: new URL('/src/assets/img/shortcuts/chatgpt.png', import.meta.url).href },
  {
    name: 'GitHub',
    icon: new URL('/src/assets/img/shortcuts/github-logo.png', import.meta.url).href,
  },
  { name: 'Gmail', icon: new URL('/src/assets/img/shortcuts/google.png', import.meta.url).href },
  { name: 'Discord', icon: new URL('/src/assets/img/shortcuts/discord.png', import.meta.url).href },
  { name: 'Tree', icon: new URL('/src/assets/img/shortcuts/tree.png', import.meta.url).href },
  {
    name: 'Hugging Face',
    icon: new URL('/src/assets/img/shortcuts/hugging.png', import.meta.url).href,
  },
  { name: 'Docker', icon: new URL('/src/assets/img/shortcuts/docker.png', import.meta.url).href },
])
